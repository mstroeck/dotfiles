# Set the only sane standard editor :-)
export EDITOR=vim
...
if [ "$color_prompt" = yes ]; then
    PS1="\[$(tput bold)\]\[$(tput setaf 3)\][LOCAL-\[$(tput setaf 1)\]\u\[$(tput setaf 3)\]]\w \[$(tput setaf 2)\]\$(parse_git_branch) \[$(tput setaf 3)\]# \[$(tput sgr0)\]"
else
    PS1="[LOCAL-\u]\w \$(parse_git_branch) # "
fi
